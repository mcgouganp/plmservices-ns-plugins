...
//  Easylink
//
//  Created by Paul McGougan on 24/9/20.
//
...
//! Project version number for Easylink.
FOUNDATION_EXPORT double EasylinkVersionNumber;

//! Project version string for Easylink.
FOUNDATION_EXPORT const unsigned char EasylinkVersionString[];

// In this header, you should import all the public headers of your framework using statements like #import <Easylink/PublicHeader.h>
